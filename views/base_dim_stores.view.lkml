view: stores {
  label: "Stores 🏪"
#   sql_table_name: looker-private-demo.retail_demo.us_stores ;;
  derived_table: {
    datagroup_trigger: monthly
    sql: SELECT * FROM looker-private-demo.retail_demo.us_stores WHERE id IN (SELECT distinct store_id from ${transactions.SQL_TABLE_NAME});;
  }
